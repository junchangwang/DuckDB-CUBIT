...
void ParquetOptions::Serialize(Serializer &serializer) const {
	...
	serializer.WritePropertyWithDefault<bool>(105, "debug_use_openssl", debug_use_openssl);
}
...
ParquetOptions ParquetOptions::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadPropertyWithDefault<bool>(105, "debug_use_openssl", result.debug_use_openssl);
	return result;
}
