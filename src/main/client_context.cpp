...
ClientContext::ClientContext(shared_ptr<DatabaseInstance> database)
    ...
    // Binning strategy for Q6. Change this config for Q3, Q14, Q15
    //      7 years
	Table_config *config_shipdate = Make_Config(s, 7, false);
	...
	s = "quantity";
    // Binning strategy for Q6
    //      <24 -> btv0
    //      =24 -> btv1
    //      >24 -> btv2 
	Table_config *config_quantity = Make_Config(s, 3, false);
	...
	s = "receiptdate";
    // Binning strategy for Q12. Change this config for other queries.
    //      7 years
	Table_config *config_receiptdate= Make_Config(s, 7, false);
