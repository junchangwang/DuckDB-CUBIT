...
/*!
Creates a value from a int64_t (a bigint)
 ...
 * returns: The value. This must be destroyed with `duckdb_destroy_value`.
 */
// TODO: different timestamp units?
