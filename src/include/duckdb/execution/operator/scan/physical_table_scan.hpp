...
public:
	...
	static void IndexRead(vector<row_t> *row_ids, uint64_t begin, uint64_t end, nbub::Nbub *bitmap_shipdate,
	                      nbub::Nbub *bitmap_discount, nbub::Nbub *bitmap_quantity, int lower_year, int upper_year,
